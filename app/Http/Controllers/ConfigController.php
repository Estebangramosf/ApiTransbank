...
class ConfigController extends Controller
{
    ...
    public $WSCLOTPC_Tiempo_OTPC;

    public $WSDL_SEND_ABOUT;
    public $WSDL_SEND_FROM;
    public $WSDL_SEND_HOST;

    public $WSDL_SEND_USER;
    public $WSDL_SEND_PASS;
    public $WSDL_SEND_MAIL;

    public $WSDL_SEND_USER_PS;
    public $WSDL_SEND_PASS_PS;
    public $WSDL_SEND_MAIL_PS;

    public $tasa_conv_CI;

    public $ecommerceHomeUrl;

    public function __construct()
    {

        /* WebService Servers Routes For Other Services */
