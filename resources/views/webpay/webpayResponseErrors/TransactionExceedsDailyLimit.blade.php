...
<html>
<head>
   <title>Transaction Exceeds Dialy Limit</title>
...
<div class="container">
   <div class="content">
      <div class="title">Transacción Excede Límite Diario</div>
      <div class="sub-title">
         Estimado cliente, <br>
         la transacción fue <br>
         rechazada por Transbank, <br>
         ya que ha excedido <br>
         el límite de transacciones diarias. <br>
      </div>
      ...
      <form id="form1" name="form1" method="post" action="{{$urlFracaso}}">
         ...
         <input type="hidden" name="message_error" value="Transacción Rechazada Excede Límite">
      </form>
