...
<div class="container">
   <div class="content">
      ...
      <div class="sub-title">
         <b>Estimado cliente, le informamos que usted  no cuenta <br>con los puntos suficientes
         para realizar el canje, por favor escoja una compra con la cantidad de puntos disponibles. <br>
         Lo redirigiremos a nuestro sitio de ventas.</b>
         <br>
         ...
         <script>
            $(function () {
               ...
               var timeVisualReddirect = 7000;
               var timeReddirect = 8000;
